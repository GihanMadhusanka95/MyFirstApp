...
const MyTrainDetails = require('../models/MyTrainDetails');
...
router.post('/MyTrainDetails/save',(req,res)=>{
...
router.get('/MyTrainDetails',(req,res)=>{
...
router.put('/MyTrainDetails/update/:id',(req,res)=>{
...
router.delete('/MyTrainDetails/delete/:id',(req,res) =>{
...
router.get('/MyTrainDetails/:id' , async(req,res)=>{

...
export default function NoticeReport() {
  return (
       ...
       <div className="row"> 
        ...
        <h4> We are going to make a full functional web application for train ticket booking. We hope to make this application make things easier for the customer. There are 4 main functions in this app, they are bookings management, customer management, employee management, and notice and feedback management. We hope to use MERN STACK to develop our project, MERN stack is a JavaScript software stack for building dynamic web applications. 
             Each functions had full crud operations.</h4>
